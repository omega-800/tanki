...
#let did = 123
#ta.add-deck(id: did, name: "some-deck")

#let my-model = ta.model(
  "some-id",
  ("Begriff", "Deutsch", "Woher/Beispiel", "Synonyme, Bedeutung"),
  (
    (
      "Jasmin's super Anki-Karte",
      "{{Deutsch}} ({{Begriff}})",
      [
        {{Synonyme, Bedeutung}} \
        {{Woher/Beispiel}}
...
#let card = ta.add-note.with(model: my-model, format: ta.template-note, deck: did)

#card("inference", "Schlussfolgerung", "type inference", "")

#card("verbatim", "wörtlich", "", "")
//
// #let (
//   deck,
//   provide-deck,
